...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    credits: 40,
    price: 29.00,
    pricePerCredit: 0.725,
    description: "40 try-ons per month - Perfect for launches",
    highlight: false,
    popular: true,
    badge: "Popular",
    monthlyQuota: 40,
  ...
  },
  {
    ...
    credits: 160,
    price: 99.00,
    pricePerCredit: 0.619,
    description: "160 try-ons per month - For active stores",
    highlight: true,
    popular: false,
    badge: "Recommended",
    monthlyQuota: 160,
  ...
  },
  {
    ...
    description: "800 try-ons per month - Designed for high volume",
    highlight: false,
    popular: false,
    badge: "Premium",
    monthlyQuota: 800,
